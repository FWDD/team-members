...
class FWDD_Team_Post_Type_Admin {
	...
	public function init() {
		...
		add_filter( 'manage_edit-' . $this->registration_handler->post_type . '_columns', array( $this, 'add_custom_columns'), 10, 1 );
		add_action( 'manage_' . $this->registration_handler->post_type . '_posts_custom_column', array( $this, 'display_columns' ), 10, 1 );
		// Make the columns sortable
		add_filter( 'manage_edit-' . $this->registration_handler->post_type . '_sortable_columns', array( $this, 'sortable_columns'), 10, 1 );
	...
	/**
	 * Make the appropriate columns sortable
	 *
	 * @param $columns
	 *
	 * @return mixed
